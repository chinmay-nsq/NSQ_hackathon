...
export function TaskDetailDialog({
  ...
  async function handleReject() {
    if (!taskId || !detail?.assignment.assignee || !rejectNote.trim()) return;
    setActing(true);
    try {
      await api.post(`/assignments/${taskId}/reject/${detail.assignment.assignee.id}`, { note: rejectNote.trim() });
