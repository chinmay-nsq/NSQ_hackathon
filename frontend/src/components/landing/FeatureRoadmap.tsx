...
const AREAS: Area[] = [
  {
    ...
    features: [
      ...
      { text: "Level, XP, coins, and pending assignments at a glance", role: "both" },
      { text: "Daily quiz auto-generates before you even ask", role: "both" },
      { text: "Extra checklist for team-lead status + approvals", role: "manager" },
    ],
  },
  {
    icon: ClipboardList,
    num: "02",
    title: "Assignments",
    tagline: "Every task, reframed as an assignment.",
    color: "#2f62ea",
    size: "lg",
    features: [
      { text: "One AI-generated solo assignment, every single day", role: "employee" },
  ...
  },
  {
    ...
    num: "03",
    title: "Teams",
    tagline: "Departments, reimagined as teams.",
    color: "#7d5f16",
    size: "md",
    features: [
      { text: "One invite link, instant team membership", role: "manager" },
      { text: "Four shared resources: Knowledge, Gold, Influence, Materials", role: "both" },
      { text: "Reputation climbs automatically as assignments get approved", role: "both" },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "AI-generated assignments skip the queue entirely", role: "both" },
    ],
  },
  {
    icon: Building2,
    num: "07",
    title: "Company",
    tagline: "One shared world every team builds together.",
    color: "#7d5f16",
    size: "md",
    features: [
      { text: "Company-wide goals every team's resources feed into", role: "both" },
  ...
  },
  {
    ...
    num: "08",
    title: "Admin",
    tagline: "The controls that keep the whole company running.",
    color: "#2f62ea",
    size: "md",
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Companion Bond Level — a second track that grows with every assignment", role: "both" },
  ...
  },
  {
    ...
    num: "10",
    title: "Onboarding",
    tagline: "From first login to your first assignment.",
    color: "#7d5f16",
    size: "lg",
    features: [
  ...
  },
  {
    ...
    size: "md",
    features: [
      { text: "AI-written narrative from real completed assignments", role: "both" },
      { text: "One click to generate, typewriter reveal", role: "both" },
      { text: "Grouped by team — your team gets its own thread", role: "both" },
    ],
  },
  {
    icon: MessageCircle,
    ...
    tagline: "Not a chatbot. A companion that actually acts.",
    color: "#2f62ea",
    size: "lg",
    features: [
